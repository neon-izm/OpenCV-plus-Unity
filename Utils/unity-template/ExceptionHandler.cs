// The #if DOTNETCORE guard is removed so native OpenCV errors are surfaced in
// Unity builds too (mirrors the Unity adaptation in the reference
// OpenCV-plus-Unity wrapper: register redirectError and throw on Occurred).
// Callbacks use a static MonoPInvokeCallback method — IL2CPP cannot marshal
// lambdas / anonymous methods (instance methods on a compiler-generated <>c).
...
public static class ExceptionHandler
{
    ...
    /// </summary>
    public static readonly CvErrorCallback ErrorHandlerCallback = ErrorHandlerCallbackImpl;

    [MonoPInvokeCallback(typeof(CvErrorCallback))]
    private static int ErrorHandlerCallbackImpl(
