...
#pragma warning disable CA1034
    ...
    {
        {typeof(byte), new MatType[] { MatType.CV_8SC1, MatType.CV_8UC1 } },
        {typeof(sbyte), new MatType[] { MatType.CV_8SC1, MatType.CV_8UC1 } },
        {typeof(short), new MatType[] { MatType.CV_16SC1, MatType.CV_16UC1 } },
        {typeof(ushort), new MatType[] { MatType.CV_16SC1, MatType.CV_16UC1 } },
        {typeof(int), new MatType[] { MatType.CV_32SC1 } },
        {typeof(float), new MatType[] { MatType.CV_32FC1 } },
        {typeof(double), new MatType[] { MatType.CV_64FC1 } },
        {typeof(Point), new MatType[] { MatType.CV_32SC2 } },
        {typeof(Point2f), new MatType[] { MatType.CV_32FC2 } },
        {typeof(Point2d), new MatType[] { MatType.CV_64FC2 } },
        {typeof(Point3i), new MatType[] { MatType.CV_32SC3 } },
        {typeof(Point3f), new MatType[] { MatType.CV_32FC3 } },
        {typeof(Point3d), new MatType[] { MatType.CV_64FC3 } },
        {typeof(Size), new MatType[] { MatType.CV_32SC2 } },
        {typeof(Size2f), new MatType[] { MatType.CV_32FC2 } },
        {typeof(Size2d), new MatType[] { MatType.CV_64FC2 } },
        {typeof(Rect), new MatType[] { MatType.CV_32SC4 } },
        {typeof(Rect2f), new MatType[] { MatType.CV_32FC4 } },
        {typeof(Rect2d), new MatType[] { MatType.CV_64FC4 } },
        //{typeof(DMatch), new[]{MatType.CV_32FC4}},
        {typeof(Vec2b), new MatType[] { MatType.CV_8UC2 } },
        {typeof(Vec2s), new MatType[] { MatType.CV_16SC2 } },
        {typeof(Vec2w), new MatType[] { MatType.CV_16UC2 } },
        {typeof(Vec2i), new MatType[] { MatType.CV_32SC2 } },
        {typeof(Vec2f), new MatType[] { MatType.CV_32FC2 } },
        {typeof(Vec2d), new MatType[] { MatType.CV_64FC2 } },
        {typeof(Vec3b), new MatType[] { MatType.CV_8UC3 } },
        {typeof(Vec3s), new MatType[] { MatType.CV_16SC3 } },
        {typeof(Vec3w), new MatType[] { MatType.CV_16UC3 } },
        {typeof(Vec3i), new MatType[] { MatType.CV_32SC3 } },
        {typeof(Vec3f), new MatType[] { MatType.CV_32FC3 } },
        {typeof(Vec3d), new MatType[] { MatType.CV_64FC3 } },
        {typeof(Vec4b), new MatType[] { MatType.CV_8UC4 } },
        {typeof(Vec4s), new MatType[] { MatType.CV_16SC4 } },
        {typeof(Vec4w), new MatType[] { MatType.CV_16UC4 } },
        {typeof(Vec4i), new MatType[] { MatType.CV_32SC4 } },
        {typeof(Vec4f), new MatType[] { MatType.CV_32FC4 } },
        {typeof(Vec4d), new MatType[] { MatType.CV_64FC4 } },
        {typeof(Vec6b), new MatType[] { MatType.CV_8UC(6) } },
        {typeof(Vec6s), new MatType[] { MatType.CV_16SC(6) } },
        {typeof(Vec6w), new MatType[] { MatType.CV_16UC(6) } },
        {typeof(Vec6i), new MatType[] { MatType.CV_32SC(6) } },
        {typeof(Vec6f), new MatType[] { MatType.CV_32FC(6) } },
        {typeof(Vec6d), new MatType[] { MatType.CV_64FC(6) } },
    };
...
// ReSharper restore InconsistentNaming
    ...
    public unsafe Span<T> AsSpan<T>() where T : unmanaged  
        => IsContinuous() ? new Span<T>(DataPointer, (int)Total() * ElemSize() / sizeof(T)) : Span<T>.Empty;
